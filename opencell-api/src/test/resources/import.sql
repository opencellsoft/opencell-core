...
--Trading Country
insert into billing_trading_country (id, version, disabled, created, provider_id, creator_id, country_id, pr_description, uuid) values (1, 0, false, now(), 1, 1, 220, 'United States', 'Trading_Country_US');
insert into billing_trading_country (id, version, disabled, created, provider_id, creator_id, country_id, pr_description, uuid) values (2, 0, false, now(), 1, 1, 70, 'France', 'Trading_Country_FR');
