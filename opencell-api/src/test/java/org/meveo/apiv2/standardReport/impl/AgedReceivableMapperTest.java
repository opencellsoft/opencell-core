...
public class AgedReceivableMapperTest {
    ...
    public void shouldReturnDynamicResponse() {
        ...
        Object[] agedReceivable = new Object[] {1, ONE,
                ...
                "CA_DESCRIPTION", new Name(new Title(), "SELLER_FIRSTNAME", "SELLER_LASTNAME"),
                "SELLER_CODE", new Date(), "EUR", 1L, "INV_1000", new BigDecimal(100), "CA_CODE", new BigDecimal(100), 1L};
