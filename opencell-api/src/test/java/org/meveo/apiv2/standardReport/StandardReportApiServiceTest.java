...
public class StandardReportApiServiceTest {
    ...
    public void shouldReturnListOfAgedReceivablesValidatedInvoices() {
    	...
    	when(recordedInvoiceService.getAgedReceivables(any(CustomerAccount.class), any(), any(PaginationConfiguration.class), isNull(), isNull(), isNull(), isNull())).thenReturn(result);
    	
    	List<Object[]> testResult = standardReportApiService.list(0L, 50L, null, null, "CA_CODE", startDate, null, null, null, null);
