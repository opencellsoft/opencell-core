...
public class StandardReportApiServiceTest {
    ...
    public void shouldReturnListOfAgedReceivablesValidatedInvoices() {
    	...
    	when(recordedInvoiceService.getAgedReceivables(any(CustomerAccount.class), any(), isNull(), any(PaginationConfiguration.class), isNull(), isNull(), isNull(), isNull())).thenReturn(result);
    	
    	List<Object[]> testResult = standardReportApiService.list(0L, 50L, null, null, "CA_CODE", startDate, null, null, null, null, null);
    ...
    public void shouldThrowExceptionIfInvoiceNumberNotFound() {
        ...
        standardReportApiService.list(0l, 5l, null, null, "CA_CODE", startDate, null,
                null, "INV_10000", 10, 2);
