...
public class DiscountPlanApiService {
    ...
    public void instanciateDP(DiscountPlanInstanciateDto discountPlanInstanciateDto) {
        ...
        if(discountPlanResource.getId() != null) {
            discountPlan = discountPlanService.findById(discountPlanResource.getId());
        }
        if(discountPlan == null && StringUtils.isNotEmpty(discountPlanResource.getCode())) {
            discountPlan = discountPlanService.findByCode(discountPlanResource.getCode());
        }
        if(discountPlan == null) {
            throw new NotFoundException("entity DiscountPlan with (id :" + discountPlanResource.getId() + ", code : "+ discountPlanResource.getCode() +" )  not found.");
        }
        ...
        if(discountPlanInstanciateDto.getServiceInstance() != null && discountPlanInstanciateDto.getServiceInstance().getId() != null) {
           ...
           Resource subscriptionResource = discountPlanInstanciateDto.getSubscription();
           ...
           subscriptionService.instantiateDiscountPlan(subscription, discountPlan);
            ...
            Resource billingAccountResource = discountPlanInstanciateDto.getBillingAccount();
