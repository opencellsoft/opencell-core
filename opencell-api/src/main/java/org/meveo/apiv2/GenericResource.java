...
@Api("Retrieve some of the properties of your lodel with the entity name, record id and the requested fields"
        + "this is not an alternative to GrahQl, just a tool to simplify some objects retrieval."
        + "for example: if the wanted fieldsare {code, description} and the requested entity is instance of customer having 2 as id,"
