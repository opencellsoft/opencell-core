...
public class PaymentGatewayApi extends BaseCrudApi<PaymentGateway, PaymentGatewayDto> {
     ...
     *
     * @param paymentGatewayDto
     *            the payment gateway dto
     * @return the long
     ...
     */
    public List<PaymentGatewayDto> list() {
	List<PaymentGatewayDto> dtos = new ArrayList<PaymentGatewayDto>();
	List<PaymentGateway> paymentGateways = paymentGatewayService.list();
	if (paymentGateways == null) {
	    return dtos;
	}
	for (PaymentGateway paymentGateway : paymentGateways) {
	    dtos.add(new PaymentGatewayDto(paymentGateway));
	}
	return dtos;
    }
