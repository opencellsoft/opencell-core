...
public class RestCorsResponseFilter implements ContainerResponseFilter {
    ...
    public void filter(ContainerRequestContext request, ContainerResponseContext response) throws IOException {
        ...
        response.getHeaders().add("Access-Control-Allow-Headers","Content-Type, Authorization, Content-Length");
...
//        response.setHeader("Access-Control-Allow-Origin", "https://wda.d2.opencell.work");
