...
public class PaymentRsImpl extends BaseRs implements PaymentRs {
	...
	@Override
	public PaymentHostedCheckoutResponseDto getHostedCheckoutUrl(String customerAccountCode, String returnUrl, String locale, String amount, String currencyCode,
			String authorizationMode, String countryCode, Boolean skipAuthentication, String gatewayPaymentName, String variant, String sellerCode) {
		...
		try {
			...
			paymentHostedCheckoutResponseDto = new PaymentHostedCheckoutResponseDto(paymentUrl, customerAccountCode, returnUrl);
		} catch (Exception e) {
			processException(e, paymentHostedCheckoutResponseDto);
