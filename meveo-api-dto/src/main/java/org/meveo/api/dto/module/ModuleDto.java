...
public class ModuleDto extends BaseDataModelDto {
    ...
    public String toString() {
        return "ModuleDto [code=" + code + ", license=" + license + ", description=" + description + ", logoPicture=" + logoPicture + ", logoPictureFile="
                + Arrays.toString(logoPictureFile) + ", cetDtos=" + cetDtos + ", cftDtos=" + cftDtos + ", filterDtos=" + filterDtos + ", jobDtos=" + jobDtos + ", jobNextDtos="
                + jobNextDtos + ", scriptDtos=" + scriptDtos + ", notificationDtos=" + notificationDtos + ", timerEntityDtos=" + timerEntityDtos + ", emailNotifDtos="
                + emailNotifDtos + ", jobTriggerDtos=" + jobTriggerDtos + ", webhookNotifDtos=" + webhookNotifDtos + ", counterDtos=" + counterDtos + ", subModules=" + subModules
                + ", measurableQuantities=" + measurableQuantities + ", charts=" + charts + "]";
    }
