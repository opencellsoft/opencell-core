 ...
 */
@MappedSuperclass
public class ProviderBusinessEntity extends AuditableEntity {

	private static final long serialVersionUID = 1L;

	@Column(name = "CODE", nullable = false, length = 35)
	// TODO: JavaEE6 migration. @Index(name = "CODE_IDX")
	@Size(min = 1, max = 35)
	@NotNull
	protected String code;

	@Column(name = "PR_DESCRIPTION", nullable = true, length = 100)
	@Size(min = 1, max = 100)
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ProviderBusinessEntity other = (ProviderBusinessEntity) obj;
		if (code == null) {
			if (other.code != null)
				return false;
