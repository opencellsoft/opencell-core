...
public class BillingAccountBean extends BaseBean<BillingAccount> {
	...
	public BillingAccount initEntity() {
		BillingAccount billingAccount = super.initEntity();
		returnToAgency = !(billingAccount.getInvoicePrefix() == null);
		if (billingAccount.getId() == null && customerAccountId != null) {
			CustomerAccount customerAccount = customerAccountService
					.findById(customerAccountId.get());
			billingAccount.setCustomerAccount(customerAccountService
					.findById(customerAccountId.get()));
