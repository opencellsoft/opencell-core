...
@JndiName("java:app/meveo-admin-ejb/JobHistoryService")
@AutoCreate
public class JobHistoryService extends PersistenceService<JobHistory> implements JobHistoryServiceLocal {
