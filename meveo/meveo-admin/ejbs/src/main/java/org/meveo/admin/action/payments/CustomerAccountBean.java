...
public class CustomerAccountBean extends BaseBean<CustomerAccount> {
    ...
    public String transferAccount() {
        try {
            customerAccountService.transferAccount(entity, getCustomerAccountTransfer(), getAmountToTransfer(), getCurrentUser());
        ...
        return "/pages/payments/customerAccounts/customerAccountDetail.xhtml?objectId=" + entity.getId() + "&edit=false&tab=ops";
    }
