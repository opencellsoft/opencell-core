...
public class DunningLOTBean extends BaseBean<DunningLOT> {
     ...
     */
    @In
    private DunningLOTServiceLocal dunningLOTService;
     ...
     */
    @Out(value = "dunningLOTs", required = false)
    protected PaginationDataModel<DunningLOT> getDataModel() {
        return entities;
    }
