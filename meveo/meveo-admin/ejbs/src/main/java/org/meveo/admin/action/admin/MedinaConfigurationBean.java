...
/**
 * Standard backing bean for {@link MedinaConfiguration} (extends {@link BaseBean} that provides almost all common methods to handle entities filtering/sorting in datatable, their
...
public class MedinaConfigurationBean extends BaseBean<MedinaConfiguration> {
    ...
    /**
     * Injected @{link MedinaConfiguration} service. Extends {@link PersistenceService}.
     */
    @Inject
