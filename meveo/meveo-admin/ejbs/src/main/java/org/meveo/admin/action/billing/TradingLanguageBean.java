...
public class TradingLanguageBean extends BaseBean<TradingLanguage> {
	 ...
	 */
	@Produces
	@Named("tradingLanguages")
	@ConversationScoped
	public PaginationDataModel<TradingLanguage> list() {
		return super.list();
	}
	...
	public String saveOrUpdate() {
		...
		for (TradingLanguage tr : getCurrentUser().getProvider().getTradingLanguage()) {
		...
		if (alreadyExist) {
			messages.error("cette langue existe déjà pour ce provider");
		} else {
