...
public class EntityListDataModelPF<T extends IEntity> extends ListDataModel<T> implements SelectableDataModel<T> {
    ...
    public T getRowData(String rowKey) {
        ...
        System.out.println("AKK get by rowKey " + rowKey);
