 ...
 */
@Stateless
@Name("griegDunningInputHistoryService")
@JndiName("java:app/meveo-admin-ejb/GriegDunningInputHistoryService")
@AutoCreate
public class GriegDunningInputHistoryService extends PersistenceService<GriegDunningInputHistory> implements
