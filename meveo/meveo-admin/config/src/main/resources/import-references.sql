...
INSERT INTO ADM_USER (ID, VERSION, DISABLED, CREATED, USERNAME, PASSWORD, LAST_PASSWORD_MODIFICATION, CREATOR_ID, PROVIDER_ID) VALUES ('1', 0, false, now(),  'MEVEO.SUPERADMIN', 'fb93a3221422999ba49eb103977a6d736376505b', now(), 1, 1);
