...
public @interface SecureMethodParameter {
	/**
	 * This attribute is used to indicate the index of a method parameter that
	 * is targeted by this annotation.
	 * 
	 * e.g. if we annotate a method that was defined as:
	 * 
	 * {@code someMethod(ObjectType1 param1, ObjectType2 param2)}
	 * 
	 * Then index 0 will refer to {@code param1} and index 1 will refer to
	 * {@code param2}.
	 * 
	 ...
	 * 
	 * Then define a property of {@code code} then during validation, the value
	 * of {@code param1.code} will be evaluated.
	 * 
	...
	/**
	 * The entity attribute refers to the entity class that will be created from
	 * the extracted data. An example for its use is if the parameter we are
	 * receiving just contains the code of a {@link BusinessEntity}. A new
	 * instance of this entity class is created and then the code will be
	 * assigned to it.
	 * 
	...
	/**
	 * The parser attribute defines the parser implementation that will be used
	 * to process the parameter. See {@link SecureMethodParameterParser} for
	 * more information.
	 * 
