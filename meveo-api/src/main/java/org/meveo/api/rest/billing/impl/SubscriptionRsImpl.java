...
public class SubscriptionRsImpl extends BaseRs implements SubscriptionRs {
	...
	public ActionStatus suspendSubscription(SuspendSubscriptionRequestDto postData) {
        ...
        try {
            subscriptionApi.suspendSubscription(postData.getSubscriptionCode(), postData.getSuspensionDate());
        } catch (Exception e) {
	...
	public ActionStatus resumeSubscription(SuspendSubscriptionRequestDto postData) {
        ...
        try {
            subscriptionApi.resumeSubscription(postData.getSubscriptionCode(), postData.getSuspensionDate());
        } catch (Exception e) {
            processException(e, result);
        }
