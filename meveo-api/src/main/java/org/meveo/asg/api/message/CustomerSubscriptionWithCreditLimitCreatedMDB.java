...
import org.meveo.asg.api.CreateUserSubscriptionWithCreditLimitRequest;
import org.meveo.asg.api.CreateUserSubscriptionWithCreditLimitResponse;
 ...
 **/
@MessageDriven(name = "CustomerSubscriptionWithCreditLimitCreatedMDB", activationConfig = {
		@ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
		@ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/createCustomerSubscriptionWithCreditLimit"),
		@ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge") })
public class CustomerSubscriptionWithCreditLimitCreatedMDB implements
		MessageListener {
	...
	private void processMessage(TextMessage msg)
		...
		CreateUserSubscriptionWithCreditLimitResponse asgResponse = new CreateUserSubscriptionWithCreditLimitResponse();
		ObjectMapper mapper = new ObjectMapper();

		try {
			String message = msg.getText();

			CreateUserSubscriptionWithCreditLimitRequest data = mapper
					.readValue(message,
