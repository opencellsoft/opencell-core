...
public class AccountHierarchyApiService extends BaseApi {
	...
	public void create(AccountHierarchyDto postData, User currentUser)
		...
		if (customerService.findByCode(postData.getCustomerId(), provider) != null) {
			...
			if (!StringUtils.isBlank(postData.getCustomerId()) && !StringUtils.isBlank(postData.getCustomerBrandCode())
					...
					&& !StringUtils.isBlank(postData.getCountryCode()) && !StringUtils.isBlank(postData.getLastName())
					&& !StringUtils.isBlank(postData.getLanguageCode()) && !StringUtils.isBlank(postData.getEmail())) {
				...
				String creditCategory = paramBean.getProperty("api.default.customerAccount.creditCategory",
						"NEWCUSTOMER");
	...
	public void update(AccountHierarchyDto postData, User currentUser)
		...
		if (!StringUtils.isBlank(postData.getCustomerId()) && !StringUtils.isBlank(postData.getCustomerBrandCode())
				&& !StringUtils.isBlank(postData.getCustomerCategoryCode())
				&& !StringUtils.isBlank(postData.getSellerCode()) && !StringUtils.isBlank(postData.getCurrencyCode())
				&& !StringUtils.isBlank(postData.getBillingCycleCode())
				&& !StringUtils.isBlank(postData.getCountryCode()) && !StringUtils.isBlank(postData.getLastName())
				&& !StringUtils.isBlank(postData.getLanguageCode()) && !StringUtils.isBlank(postData.getEmail())) {
	...
	public CustomersDto find(AccountHierarchyDto postData, User currentUser) throws MeveoApiException {
		...
		if (postData.getCustomFields() != null) {
			for (@SuppressWarnings("unused") CustomFieldDto cfDto : postData.getCustomFields().getCustomField()) {
