...
public class SellerWsTest extends BaseWsTest {

	private static Logger log = Logger.getLogger(SellerWsTest.class.getName());
	...
	public static Archive<?> createTestArchive() {
		...
		// seller
		result = result.addClasses(SellerWsImpl.class, SellerWs.class,
	...
	public void testVersion(
			@ArquillianResteasyResource("api/rest") SellerWs resource) {
