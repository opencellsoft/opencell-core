...
/**
 * Standard backing bean for {@link NotificationHistory} (extends {@link BaseBean} that provides almost all common methods to handle entities filtering/sorting in datatable, their
...
public class NotificationHistoryBean extends BaseBean<NotificationHistory> {
    ...
    /**
     * DataModel for primefaces lazy loading datatable component for a particular notification
     * 
