...
@Named
@ConversationScoped
public class OtherTransactionListBean extends OtherTransactionBean {
...
//            operationIds.add(p.getOtherTransaction().getId());
//        }
//        try {
//            MatchingReturnObject result = matchingCodeService.matchOperations(partialMatchingOccSelected.getOtherTransaction().getCustomerAccount().getId(), null, operationIds,
//                partialMatchingOccSelected.getOtherTransaction().getId());
//            if (result.isOk()) {
...
//        }
//        return "/pages/payments/customerAccounts/customerAccountDetail.xhtml?customerAccountId=" + partialMatchingOccSelected.getOtherTransaction().getCustomerAccount().getId()
