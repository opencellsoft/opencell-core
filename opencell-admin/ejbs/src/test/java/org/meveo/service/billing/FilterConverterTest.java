...
public class FilterConverterTest {
	...
	public void shouldConvertFiltersToTargetTypesWithSameValues() {
		...
		assertEquals(RatedTransactionStatusEnum.BILLED, convertedFilters.get("ne status"));
		assertEquals(new BigDecimal(20.23).setScale(2, HALF_UP), ((BigDecimal) convertedFilters.get("fromRange unitAmountWithTax")).setScale(2, HALF_UP));
