...
public class PersistenceServiceTest {
    ...
    public void test_empty_filters() {
        assertThat(getQuery()).isEqualTo("from org.meveo.model.billing.Invoice a left join fetch a.fetchField");
    }
    ...
    public void test_search_att_type_class_class() {
        ...
        assertThat(getQuery()).isEqualTo("from org.meveo.model.billing.Invoice a left join fetch a.fetchField where type(a) = :typeClass Param name:typeClass value:class org.meveo.model.billing.Invoice");
    }
    ...
    public void test_search_att_type_class_string() {
        ...
        assertThat(getQuery()).isEqualTo("" +
                "from org.meveo.model.billing.Invoice a left join fetch a.fetchField where type(a) = :typeClass Param name:typeClass value:class org.meveo.model.billing.Invoice");
    }
    ...
    public void test_search_by_is_null_json() {
        ...
        assertThat(getQuery()).isEqualTo("from org.meveo.model.billing.Invoice a left join fetch a.fetchField where keyFromJson(a.cfValues,jsonField) is null ");
    }

    @Test
    public void test_search_by_is_null_collection() {
        filters.put("key invoiceAgregates", SEARCH_IS_NULL);
        assertThat(getQuery()).isEqualTo("from org.meveo.model.billing.Invoice a left join fetch a.fetchField where a.invoiceAgregates is empty ");
    }

    @Test
    public void test_search_by_is_not_null() {
        filters.put("key" + FROM_JSON_FUNCTION + "jsonField)", SEARCH_IS_NOT_NULL);
        assertThat(getQuery()).isEqualTo("from org.meveo.model.billing.Invoice a left join fetch a.fetchField where keyFromJson(a.cfValues,jsonField) is not null ");
    }

    @Test
    public void test_search_by_is_not_null_collections() {
        filters.put("key invoiceAgregates", SEARCH_IS_NOT_NULL);
        assertThat(getQuery()).isEqualTo("from org.meveo.model.billing.Invoice a left join fetch a.fetchField where a.invoiceAgregates is not empty ");
    }
    ...
    public void test_base_entity() {
        ...
        assertThat(getQuery()).isEqualTo("from org.meveo.model.billing.Invoice a left join fetch a.fetchField where a.eq = :a_eq Param name:a_eq value:Invoice[id=1, invoiceNumber=null, invoiceType=null]");
    }
    ...
    public void test_auditable_hash_map() {
        ...
        assertThat(getQuery()).isEqualTo("from org.meveo.model.billing.Invoice a left join fetch a.fetchField where (a.auditable.1>=:startaauditable1 and a.auditable.1<:endaauditable1) Param name:startaauditable1 value:Wed Jan 01 00:00:00 WET 2020 Param name:endaauditable1 value:Thu Jan 02 00:00:00 WET 2020");
    }
