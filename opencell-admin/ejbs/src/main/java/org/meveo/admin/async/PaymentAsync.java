    ...
    public Future<String> launchAndForget(List<Long> caIds, JobExecutionResultImpl result, boolean createAO, boolean matchingAO, PaymentGateway paymentGateway,
        ...
        for (Long caID : caIds) {
            ...
            if (operationCategory == OperationCategoryEnum.CREDIT) {
                ...
                log.info("listAoToPayOrRefund before filter size:"+(listAoToPayOrRefund==null?"null":listAoToPayOrRefund.size()));
            ...
            log.info("listAoToPayOrRefund size:"+(listAoToPayOrRefund==null?"null":listAoToPayOrRefund.size()));
