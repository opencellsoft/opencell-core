...
public class PaymentCardJobBean {
    ...
    public void execute(JobExecutionResultImpl result, JobInstance jobInstance) {
        ...
        try {
            ...
            PaymentGateway paymentGateway = paymentGatewayService.findByCode(((EntityReferenceWrapper) customFieldInstanceService.getCFValue(jobInstance, "ScriptingJob_script")).getCode());
            try {
            ...
            while (subListCreator.isHasNext()) {
                futures.add(paymentCardAsync.launchAndForget((List<Long>) subListCreator.getNextWorkSet(), result, createAO, matchingAO,paymentGateway));
