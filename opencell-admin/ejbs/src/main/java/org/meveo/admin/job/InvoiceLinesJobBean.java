...
public class InvoiceLinesJobBean extends BaseJobBean {
    ...
    private List<Map<String, Object>> getGroupedRTs(Map<String, Object> params) {
        String query = "SELECT rt.id, rt.billing_account__id, \n" +
                ...
                "				  rt.order_id, rt.product_version_id, rt.order_lot_id, charge_instance_id, rt.article_id ,discounted_Ratedtransaction_id, discount_plan_id \n" +
                ...
                "		  rt.order_id, rt.product_version_id, rt.order_lot_id, charge_instance_id, rt.id, rt.article_id ,discounted_ratedtransaction_id, discount_plan_id order by unit_amount_without_tax desc \n";
