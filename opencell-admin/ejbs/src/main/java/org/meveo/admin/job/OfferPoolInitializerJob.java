...
public class OfferPoolInitializerJob extends Job {
    ...
    /** The pool initializer job bean. */
    @Inject
    private OfferPoolInitializerJobBean offerPoolInitializerJobBean;

    @Override
    @TransactionAttribute(TransactionAttributeType.NEVER)
    protected void execute(JobExecutionResultImpl result, JobInstance jobInstance) throws BusinessException {
        offerPoolInitializerJobBean.execute(result, jobInstance);
    }
    ...
    public Map<String, CustomFieldTemplate> getCustomFields() {
        ...
        customFieldNbRuns.setAppliesTo("JobInstance_OfferPoolInitializerJob");
        ...
        customFieldNbWaiting.setAppliesTo("JobInstance_OfferPoolInitializerJob");
        ...
        CustomFieldTemplate customFieldDate = new CustomFieldTemplate();
