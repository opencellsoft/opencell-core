...
public class PurgeMediationDataJobBeanV2 extends BaseJobBean {
	...
	public void execute(JobExecutionResultImpl result, JobInstance jobInstance) {
		...
		if (targetRtStatus!= null && !targetRtStatus.isEmpty()) {
			...
			totalPurgedRows += purgeMediationData(jobInstance, firstTransactionDate, nbDays, targetRtStatus, RatedTransaction.class);
		}
		// Purge Edrs
		if (targetEdrStatus != null && !targetEdrStatus.isEmpty()) {
			...
			totalPurgedRows += purgeMediationData(jobInstance, firstTransactionDate, nbDays, targetEdrStatus, EDR.class);
		}
