...
/**
 * The Class FlatFileProcessingJob consume any flat file and execute the given
 * script for each line/record, the beanIO is used to describe file format.
 * 
 * @author anasseh
 *
 * @lastModifiedVersion 6.4.5
 */
@Stateless
