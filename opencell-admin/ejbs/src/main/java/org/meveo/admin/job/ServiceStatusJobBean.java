...
public class ServiceStatusJobBean extends IteratorBasedJobBean<Long> {
    ...
    public void execute(JobExecutionResultImpl jobExecutionResult, JobInstance jobInstance) {
        super.execute(jobExecutionResult, jobInstance, this::initJobAndGetDataToProcess, this::updateServiceStatus, null, null);
    }
    ...
    private void updateServiceStatus(Long serviceId, JobExecutionResultImpl jobExecutionResult) {
        ...
        }else if (serviceInstance.getStatus() == InstanceStatusEnum.PENDING) {
