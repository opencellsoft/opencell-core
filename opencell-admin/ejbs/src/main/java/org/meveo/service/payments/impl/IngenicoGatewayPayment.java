...
public class IngenicoGatewayPayment implements GatewayPaymentInterface {
	...
	private PaymentStatusEnum mappingStaus(String ingenicoStatus) {
		...
		if ("CREATED".equals(ingenicoStatus) || "PAID".equals(ingenicoStatus) || "REFUNDED".equals(ingenicoStatus) || "CAPTURED".equals(ingenicoStatus)
				|| ingenicoStatus.equals("REVERSED") || ingenicoStatus.equals("CHARGEBACKED")) {
			return PaymentStatusEnum.ACCEPTED;
		}
		if (ingenicoStatus.startsWith("PENDING") || ingenicoStatus.equals("PAYOUT_REQUESTED") || ingenicoStatus.equals("ACCOUNT_VERIFIED")
				|| ingenicoStatus.equals("AUTHORIZATION_REQUESTED") || ingenicoStatus.equals("CAPTURE_REQUESTED") || ingenicoStatus.equals("REFUND_REQUESTED")) {
