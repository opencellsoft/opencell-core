...
public class AccountingPeriodService extends PersistenceService<AccountingPeriod> {
	...
	public AccountingPeriod updateAccountingPeriod(AccountingPeriod entity, Date startDateInput, Date endDateInput, Boolean isUseSubAccountingPeriods, String subAccountingPeriodType) {
		...
		if (entity.isUseSubAccountingCycles() && Boolean.FALSE.equals(isUseSubAccountingPeriods)) {
		...
		if (!entity.getSubAccountingPeriodType().equals(SubAccountingPeriodTypeEnum.valueOf(subAccountingPeriodType)) && isUsedOnAccountingOperations(entity)) {
