...
public class FilterConverter {
	...
	/**
	 * Convert filters maps from String to field type filters : Map of filters Map<String, String> Return : converted map of filters Map<String, Object>
	 */
	...
	private Object convert(Class<?> entity, Map.Entry<String, String> filterEntry, String fieldName) {
		...
		} catch (NoSuchFieldException | NoSuchMethodException | IllegalAccessException | InvocationTargetException | ParseException exception) {
			log.error(exception.getMessage());
		}
		return null;
	}

	private Object toNumber(Class<?> entity, String key, String value) throws NoSuchFieldException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
