...
public class RatedTransactionService extends PersistenceService<RatedTransaction> {
    ...
    public void createInvoiceAndAgregates(BillingAccount billingAccount, Invoice invoice, Filter ratedTransactionFilter, String orderNumber, Date lastTransactionDate)
    ...
    public void createInvoiceAndAgregates(BillingAccount billingAccount, Invoice invoice, Filter ratedTransactionFilter, List<RatedTransaction> ratedTransactions,
        ...
        for (UserAccount userAccount : userAccounts) {
            ...
            for (Object[] object : invoiceSubCats) {
                ...
                String invSubCatDescTranslated = invoiceSubCategory.getDescriptionOrCode();
                ...
                if (catInvoiceAgregateMap.containsKey(invoiceCategoryId)) {
                    ...
                    String invCatDescTranslated = invoiceSubCategory.getInvoiceCategory().getDescriptionOrCode();
                    if (invoiceSubCategory.getInvoiceCategory().getDescriptionI18n() != null && invoiceSubCategory.getInvoiceCategory().getDescriptionI18n().containsKey(languageCode)) {
    ...
    public Boolean isBillingAccountBillable(BillingAccount billingAccount, Date lastTransactionDate) {
        ...
        count = q.setParameter("billingAccount", billingAccount).setParameter("lastTransactionDate", lastTransactionDate).getSingleResult();
    ...
    public RatedTransaction createRatedTransaction(WalletOperation walletOperation, boolean isVirtual) throws BusinessException {
        ...
        InvoiceSubCategory invoiceSubCategory = walletOperation.getInvoiceSubCategory() != null ? walletOperation.getInvoiceSubCategory()
                : walletOperation.getChargeInstance().getChargeTemplate().getInvoiceSubCategory();
        /*
