...
public interface IXmlInvoiceCreatorScript extends ScriptInterface {
     ...
     * @throws IOException                  IO exception
     */
    Document createDocument(Invoice invoice, boolean isVirtual, boolean rtBillingProcess) throws BusinessException, ParserConfigurationException, SAXException, IOException;
