...
public class ServiceTemplateBean extends StatelessBaseBean<ServiceTemplate> {
	...
	@Named
	@Produces
	private ServiceChargeTemplateUsage serviceUsageChargeTemplate = new ServiceChargeTemplateUsage();

	public void newServiceChargeTemplateUsage() {
		this.serviceUsageChargeTemplate = new ServiceChargeTemplateUsage();
	}
	...
	public String saveServiceChargeTemplateUsage() {
		...
		serviceUsageChargeTemplate = new ServiceChargeTemplateUsage();

		return null;
	}

	public void deleteServiceChargeTemplateUsage(ServiceChargeTemplateUsage serviceUsageChargeTemplate) {
	...
	public void editServiceChargeTemplateUsage(ServiceChargeTemplateUsage serviceUsageChargeTemplate) {
	...
	public void setServiceChargeTemplateUsage(ServiceChargeTemplateUsage serviceUsageChargeTemplate) {
		this.serviceUsageChargeTemplate = serviceUsageChargeTemplate;
	}
