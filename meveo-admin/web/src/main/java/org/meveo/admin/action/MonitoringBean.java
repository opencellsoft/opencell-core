	...
	public String getLastVersion() {
		...
		if(versionOutput!=null){
			...
			try {
				...
				String keyEntreprise= ParamBean.getInstance().getProperty("monitoring.enterpriseKey","");
				...
				String urlMoni = ParamBean.getInstance().getProperty("monitoring.url","http://version.meveo.info/meveo-moni")+"/api/rest/getVersion";
	...
	public String getDocUrl() {
		...
		try {			
			...
			if(docUrlMap.containsKey(fullURI)){
				...
				String urlDoc = ParamBean.getInstance().getProperty("monitoring.url","http://version.meveo.info/meveo-moni")+"/api/rest/documentation";
