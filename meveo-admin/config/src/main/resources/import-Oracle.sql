...
﻿-- Providers
INSERT INTO CRM_PROVIDER (ID,VERSION,DISABLED,CREATED,UPDATED,CODE,DESCRIPTION,PAYMENT_METHODS,INVOICE_PREFIX,BANK_CODE,BRANCH_CODE,ACCOUNT_NUMBER,KEY,IBAN,BIC,ACCOUNT_OWNER,BANK_NAME,BANK_ID,ISSUER_NUMBER,ISSUER_NAME,UPDATER_ID,CREATOR_ID,PROVIDER_ID, entreprise, automatic_invoicing,AMOUNT_VALIDATION,LEVEL_DUPLICATION, DISPAL_FREE_TX_INVOICE) VALUES (1,1,0,sysdate,null,'MYCOMPANY',null,null,null,'SGMB','12345','33333333333','11','11','11','owner','SGMB','11','1111','PROV1',null,null,null,0,0,0,0,true);
INSERT INTO CRM_PROVIDER (ID,VERSION,DISABLED,CREATED,UPDATED,CODE,DESCRIPTION,PAYMENT_METHODS,INVOICE_PREFIX,BANK_CODE,BRANCH_CODE,ACCOUNT_NUMBER,KEY,IBAN,BIC,ACCOUNT_OWNER,BANK_NAME,BANK_ID,ISSUER_NUMBER,ISSUER_NAME,UPDATER_ID,CREATOR_ID,PROVIDER_ID, entreprise, automatic_invoicing,AMOUNT_VALIDATION,LEVEL_DUPLICATION, DISPAL_FREE_TX_INVOICE) VALUES (2,1,0,sysdate,null,'OTHERCOPANY',null,null,null,'CIC','54321','22222222222','22','22','22','owner2','CIC','12','2222','PROV22',null,null,null,0,0,0,0,true);
