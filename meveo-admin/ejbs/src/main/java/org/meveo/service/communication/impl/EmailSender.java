...
public class EmailSender {
	...
	public void sent(String from, List<String> replyTo, List<String> to, String subject, String textContent, String htmlContent) throws MissingParameterException, AddressException, MessagingException {
		sent(from, replyTo, to, null, null, subject, textContent, htmlContent, null, null);
	}

	public void sent(String from, List<String> replyTo, List<String> to, List<String> cc, List<String> bcc, String subject, String textContent, String htmlContent, List<File> attachments, Date sendDate) throws MissingParameterException, AddressException, MessagingException {
