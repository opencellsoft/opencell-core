...
public class InvoiceService extends PersistenceService<Invoice> {
	...
	public void createAgregatesAndInvoice(BillingAccount billingAccount,
		...
		invoice.setProvider(billingRun.getProvider());
		create(invoice);
		ratedTransactionService.createInvoiceAndAgregates(billingRun,
				billingAccount, invoice);

		ratedTransactionService.updateRatedTransactions(billingRun,
				billingAccount, invoice);
