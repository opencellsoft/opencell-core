...
public class CustomerAccountService extends AccountService<CustomerAccount> {
	...
	public BigDecimal customerAccountBalanceDue(Long customerAccountId,
		...
		return customerAccountBalanceDue(getEntityManager(), customerAccountId,
				customerAccountCode, to);

	}

	public BigDecimal customerAccountBalanceDue(EntityManager em,
			Long customerAccountId, String customerAccountCode, Date to)
			throws BusinessException {
		log.info("start customerAccountBalanceDue with id:" + customerAccountId
				+ ",code:" + customerAccountCode + ",toDate:" + to);
		return customerAccountBalanceDue(
				findCustomerAccount(em, customerAccountId, customerAccountCode),
				to);
	}
	...
	public CustomerAccount findCustomerAccount(EntityManager em, Long id,
