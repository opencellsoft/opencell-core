...
public class MeasuredValueService extends PersistenceService<MeasuredValue> {
	...
	public List<String> getDimensionList(int dimensionIndex, Date fromDate,
			Date toDate,MeasurableQuantity mq){
		List<String> result = new ArrayList<String>();
		Calendar end = Calendar.getInstance();
		//result.add("");
		String dimension="dimension"+dimensionIndex;
		String sqlQuery = "SELECT DISTINCT(mv."+dimension+") FROM "
						+ MeasuredValue.class.getName()
