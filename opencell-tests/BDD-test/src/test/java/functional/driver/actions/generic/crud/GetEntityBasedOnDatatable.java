...
public class GetEntityBasedOnDatatable implements Task {

    private final String entityName;
    private final DataTable dataTable;

    public GetEntityBasedOnDatatable(String entityName, DataTable dataTable) {
        this.entityName = entityName;
        this.dataTable = dataTable;
    }

    public static GetEntityBasedOnDatatable called(String entity, DataTable dataTable) {
        return Tasks.instrumented(GetEntityBasedOnDatatable.class, entity, dataTable);
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        for (Map<String, String> anInstance : table) {
            ...
            String urlForGetRequest = ApiUtils.getUrlForGetFromDataTable(entityName, baseUrl, anInstance);
            actor.attemptsTo(
