   ...
   Feature: Testing mediation process
     ...
     Scenario: Testing mediation process
       ...
       Given  I create entity "Subscription", with field and value
         ...
         | subCodeThang_5  | a description for Subscription | OPENSOFT-01  | OF_BASIC       |
