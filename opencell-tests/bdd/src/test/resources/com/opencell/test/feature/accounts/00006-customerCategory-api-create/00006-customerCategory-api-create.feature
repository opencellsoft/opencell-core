...
Feature: Create Customer Category by API
  ...
  Scenario Outline: Create Customer Category by API
    ...
    Examples: 
      ...
      | accounts/00006-customerCategory-api-create/INVALID_PARAMETER.json     | CustomerCategoryDto | /account/customer/createOrUpdateCategory |        400 | FAIL    | INVALID_PARAMETER                | Can not deserialize value of type java.lang.Boolean from String               |
