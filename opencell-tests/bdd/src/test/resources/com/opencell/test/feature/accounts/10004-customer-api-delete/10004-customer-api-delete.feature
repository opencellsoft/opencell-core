...
Feature: Delete a Customer by API
  ...
  Scenario Outline: Delete a Customer by API
    ...
    Examples: 
      ...
      | accounts/10004-customer-api-delete/ENTITY_DOES_NOT_EXIST.json | CustomerDto | /account/customer/ |        404 | FAIL    | ENTITY_DOES_NOT_EXISTS_EXCEPTION | Customer with code=NOT_EXIST does not exists. |
