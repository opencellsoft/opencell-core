...
Feature: Create invoice sequence by API
  ...
  Scenario Outline: Create invoice sequence by API
    ...
    Examples: 
      ...
      | billing/00005-invoiceSequence-api-create/INVALID_PARAMETER.json | InvoiceSequenceDto | /invoiceSequence/createOrUpdate |        400 | FAIL    | INVALID_PARAMETER | Cannot deserialize value of type `java.lang.Integer` from String       |
