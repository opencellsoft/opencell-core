...
Feature: Create/Update Wallet operation by API
  ...
  Scenario Outline: <status> <action> Wallet operation by API <errorCode>
    ...
    Examples: 
      ...
      | api/billing/00006-walletOperation-api-create/MISSING_PARAMETER.json | WalletOperationDto | /billing/wallet/operation | POST   |        400 | FAIL    | MISSING_PARAMETER               | MISSING_PARAMETER |
