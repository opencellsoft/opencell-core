...
Feature: Delete a Customer Account by API
  ...
  Scenario Outline: Delete a Customer Account by API
    ...
    Examples: 
      ...
      | accounts/10003-customerAccount-api-delete/ENTITY_DOES_NOT_EXIST.json | CustomerAccountDto | /account/customerAccount/ |        404 | FAIL    | ENTITY_DOES_NOT_EXISTS_EXCEPTION | CustomerAccount with code=NOT_EXIST does not exists. |
