...
Feature: Create a Customer by API
  ...
  Scenario Outline: Create a Customer by API
    ...
    Examples: 
      ...
      | accounts/00001-customer-api-create/INVALID_PARAMETER.json      | CustomerDto | /account/customer/createOrUpdate |        400 | FAIL    | INVALID_PARAMETER                | Cannot deserialize value of type `java.util.Date` from String                      |
