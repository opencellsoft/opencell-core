...
Feature: Create a Customer Account by API
  ...
  Scenario Outline: Create a Customer Account by API
    ...
    Examples: 
      ...
      | accounts/00002-customerAccount-api-create/INVALID_PARAMETER.json     | CustomerAccountDto | /account/customerAccount/createOrUpdate |        400 | FAIL    | INVALID_PARAMETER                | Cannot deserialize value of type `java.util.Date` from String                        |
