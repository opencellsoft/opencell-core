...
Feature: Create a module by API
  ...
  Scenario Outline: Create an accounting code by API
    ...
    Examples: 
      ...
      | administration/00002-module-api-create/INVALID_PARAMETER.json | MeveoModuleDto | /module/createOrUpdate |        400 | FAIL    | INVALID_PARAMETER | Can not deserialize value of type org.meveo.model.module.ModuleLicenseEnum from String |
