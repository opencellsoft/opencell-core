...
Feature: Create an accounting code by API
  ...
  Scenario Outline: Create an accounting code by API
    ...
    Examples: 
      ...
      | accounting/00001-accountCode-api-create/INVALID_PARAMETER.json | AccountingCodeDto | /billing/accountingCode/createOrUpdate |        400 | FAIL    | INVALID_PARAMETER | Cannot deserialize value of type `org.meveo.model.billing.ChartOfAccountViewTypeEnum` from String                   |
