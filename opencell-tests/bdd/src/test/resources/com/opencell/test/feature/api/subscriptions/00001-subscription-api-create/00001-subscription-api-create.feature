...
Feature: Create/Update subscription Plan by API
  ...
  Scenario Outline: <status> <action> subscription by API <errorCode>
    ...
    Examples: 
      ...
      | api/subscriptions/00001-subscription-api-create/MISSING_PARAMETER.json                | SubscriptionDto | /billing/subscription/createOrUpdate | CreateOrUpdate |        400 | FAIL    | MISSING_PARAMETER                | The following parameters are required or contain invalid values: offerTemplate. |
