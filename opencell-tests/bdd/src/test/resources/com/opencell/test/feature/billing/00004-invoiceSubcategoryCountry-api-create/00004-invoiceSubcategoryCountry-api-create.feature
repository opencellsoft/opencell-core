...
Feature: Create an invoice subcategory country by API
  ...
  Scenario Outline: Create an invoice subcategory country by API
    ...
    Examples: 
      ...
      | billing/00004-invoiceSubcategoryCountry-api-create/INVALID_PARAMETER.json                | InvoiceSubCategoryCountryDto | /invoiceSubCategoryCountry/createOrUpdate |        400 | FAIL    | INVALID_PARAMETER                | Can not deserialize value of type int from String               |
