...
Scenario: Create access point
Given  The subscription is created
And    Field "Access point code" is filled in with a AccesspointCode
And    Field "subscription" is filled in with a SubscriptionCode
When   I Press "save" button
Then   The access point is activated

Scenario: Run Mediation job
Given  CDRs are already generated
When   I Press "Run" button
Then   The job is executed 

Scenario: Run usage job
Given  EDRs are already generated
When   I Press "Run" button
Then   The job is executed 
...
Then   The service is activated
   ...
   Scenario Outline: Create access point
Given  The subscription is created
And    Field "Access point code" is filled in with a <AccesspointCode>
And    Field "subscription" is filled in with a <SubscriptionCode>
When   I Press "save" button
Then   The access point is activated
   ...
   Scenario Outline: Run Mediation job
Given  CDRs are already generated
When   I Press "Run" button
Then   The job is executed
   Examples:
   ...
   Scenario Outline: Run usage job
Given  EDRs are already generated
When   I Press "Run" button
Then   The job is executed
   Examples:
