...
Feature: Create Billing run by API
  ...
  Scenario Outline: <status> <action> Billing run by API <errorCode>
    ...
    Examples: 
      ...
      | api/invoicing/00002-billingRun-api-create/SuccessTest.json                      | CreateBillingRunDto | /billing/invoicing/createBillingRun | Create |        200 | SUCCESS |                                  |                                                                                                |
      | api/invoicing/00002-billingRun-api-create/SuccessTest1.json                     | CreateBillingRunDto | /billing/invoicing/createBillingRun | Create |        200 | SUCCESS |                                  |                                                                                                |
      | api/invoicing/00002-billingRun-api-create/SuccessTest2.json                     | CreateBillingRunDto | /billing/invoicing/createBillingRun | Create |        200 | SUCCESS |                                  |                                                                                                |
