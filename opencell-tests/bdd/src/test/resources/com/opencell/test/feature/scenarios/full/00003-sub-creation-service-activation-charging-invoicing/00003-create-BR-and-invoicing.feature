...
Feature: Create BR and Invoicing
  ...
  Scenario Outline: <title>
    ...
    Examples: 
      ...
      | scenarios/full/00003-sub-creation-service-activation-charging-invoicing/03-create-BR-and-invoicing/validated-BR.json           | validate BR           | BillingCycleDto     | /billing/invoicing/validateBillingRun | Create |        200 | SUCCESS |           |         |        |          |
