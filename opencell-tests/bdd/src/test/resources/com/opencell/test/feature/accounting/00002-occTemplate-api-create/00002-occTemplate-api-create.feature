...
Feature: Create OCC Template by API
  ...
  Scenario Outline: Create OCC Template by API
    ...
    Examples: 
      ...
      | accounting/00002-occTemplate-api-create/INVALID_PARAMETER.json | OccTemplateDto | /occTemplate/createOrUpdate |        400 | FAIL    | INVALID_PARAMETER               | Can not deserialize value of type org.meveo.model.payments.OperationCategoryEnum from String   |
