...
Feature: Create CountryIso by API
  ...
  Scenario Outline: Create CountryIso by API
    ...
    Examples: 
      ...
      | settings/00005-countryIso-api-create/INVALID_PARAMETER.json                | CountryIsoDto | /countryIso/createOrUpdate |        400 | FAIL    | INVALID_PARAMETER                | Cannot deserialize instance of `java.util.ArrayList` out of VALUE_STRING       |
