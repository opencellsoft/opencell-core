...
Feature: Create Provider Contact by API
  ...
  Scenario Outline: Create Provider Contact by API
    ...
    Examples: 
      ...
      | accounts/00004-providerContact-api-create/INVALID_PARAMETER.json     | ProviderContactDto | /account/providerContact/createOrUpdate |        400 | FAIL    | INVALID_PARAMETER               | Can not construct instance of org.meveo.api.dto.account.AddressDto: no String-argument               |  |
