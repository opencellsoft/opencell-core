...
Feature: Check that ServiceTemplate CF are visible during createOfferFromBOM
  ...
  Scenario Outline: Check that ServiceTemplate CF are visible during createOfferFromBOM
    ...
    Examples: 
      ...
      | api/core/ticket-4928/SuccessTest5.json | /catalog/serviceTemplate/list | Get    |        200 | SUCCESS | api/core/ticket-4928/Val_aString_attendue_4.json | api/core/ticket-4928/Val_aStringFiltered_attendue_4.json |
      | api/core/ticket-4928/SuccessTest5.json | /catalog/serviceTemplate/list | Get    |        200 | SUCCESS | api/core/ticket-4928/Val_aString_attendue_5.json | api/core/ticket-4928/Val_aStringFiltered_attendue_5.json |
      | api/core/ticket-4928/SuccessTest6.json | /catalog/serviceTemplate/list | Get    |        200 | SUCCESS | api/core/ticket-4928/Val_aString_attendue_6.json | api/core/ticket-4928/Val_aStringFiltered_attendue_6.json |
      | api/core/ticket-4928/SuccessTest7.json | /catalog/serviceTemplate/list | Get    |        200 | SUCCESS | api/core/ticket-4928/Val_aString_attendue_7.json | api/core/ticket-4928/Val_aStringFiltered_attendue_7.json |
      | api/core/ticket-4928/SuccessTest8.json | /catalog/serviceTemplate/list | Get    |        200 | SUCCESS | api/core/ticket-4928/Val_aString_attendue_8.json | api/core/ticket-4928/Val_aStringFiltered_attendue_8.json |
