...
Feature: Create Calendar by API
  ...
  Scenario Outline: Create Calendar by API
    ...
    Examples: 
      ...
      | settings/00003-calendar-api-create/GENERIC_API_EXCEPTION.json | CalendarDto | /calendar/createOrUpdate |        500 | FAIL    | GENERIC_API_EXCEPTION           | result returns more than one elements                                            |
      | settings/00003-calendar-api-create/INVALID_PARAMETER.json     | CalendarDto | /calendar/createOrUpdate |        400 | FAIL    | INVALID_PARAMETER               | Can not deserialize value of type org.meveo.api.dto.CalendarTypeEnum from String |
