...
Feature: Create offer template by API
  ...
  Scenario Outline: Create offer template by API
    ...
    Examples: 
      ...
      | offers/00001-offerTemplate-api-create/SucessTest.json                  | OfferTemplateDto | /catalog/offerTemplate/createOrUpdate |        200 | SUCCESS |                   |                                                                                |
      | offers/00001-offerTemplate-api-create/INVALID_PARAMETER.json           | OfferTemplateDto | /catalog/offerTemplate/createOrUpdate |        400 | FAIL    | INVALID_PARAMETER | Cannot deserialize value of type `org.meveo.model.catalog.LifeCycleStatusEnum` |
