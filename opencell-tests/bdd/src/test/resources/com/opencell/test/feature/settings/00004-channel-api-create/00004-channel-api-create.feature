...
Feature: Create Channel by API
  ...
  Scenario Outline: Create Channel by API
    ...
    Examples: 
      ...
      | settings/00004-channel-api-create/INVALID_PARAMETER.json | ChannelDto | /catalog/channel/createOrUpdate |        400 | FAIL    | INVALID_PARAMETER               | Can not deserialize value of type java.lang.Boolean from String        |
