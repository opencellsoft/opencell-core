...
Feature: Create, modify and delete Title and civility
  ...
  Scenario Outline: Create a title and civilities by API
    ...
    Examples: 
      ...
      | settings/00002-titles-api-create/INVALID_PARAMETER.json | TitleDto | /account/title/createOrUpdate |        400 | FAIL    | INVALID_PARAMETER               | Can not deserialize value of type java.lang.Boolean from String             |
