...
public class EnumBuilder {
     ...
     *
     * @PostConstruct public void init() { EnumBuilder.put(JobCategoryEnum.class, Arrays.stream(CustomJobCategoryEnum.values()).collect(Collectors.toMap(item -> item.name(), item
     *                -> item))); } }
     *
     */
