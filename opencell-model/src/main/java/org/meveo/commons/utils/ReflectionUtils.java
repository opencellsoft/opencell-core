...
public class ReflectionUtils {
	...
	/**
	 * Convert a java type classname to a fuman readable name. E.g.
	 * CustomerAccount >> Customer Account
	 * 
	 * @param classname
	 *            Full or simple classname
	...
	public static Class<?> getClassBySimpleNameAndAnnotation(String className,
	 ...
	 * 
	 * @param className
	 *            Simple classname to match
	 * @param parentClass
	 *            Parent or interface class
	 ...
	 * @param clazz
	 *            Class to check
	 * @return True if class is annotated with @Entity, @Embeddable
	 *         or @XmlRootElement
	 */
