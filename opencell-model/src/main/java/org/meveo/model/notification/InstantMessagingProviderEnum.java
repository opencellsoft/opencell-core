...
public enum InstantMessagingProviderEnum {
    SKYPE(1, "enum.InstantMessagingProviderEnum.SKYPE"), FACEBOOK(2, "enum.InstantMessagingProviderEnum.FACEBOOK"), TWITTER(3, "enum.InstantMessagingProviderEnum.TWITTER"), GTALK(
