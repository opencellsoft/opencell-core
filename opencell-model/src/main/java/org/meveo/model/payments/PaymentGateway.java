...
public class PaymentGateway extends BusinessCFEntity {
	...
	return "PaymentGateway [type=" + type + ", paymentMethodType="+paymentMethodType+", scriptInstance=" + (scriptInstance == null ? null : scriptInstance.getCode()) + ", implementationClassName=" + implementationClassName
		+ ", applicationEL=" + applicationEL + ", tradingCountry=" + tradingCountry + ", tradingCurrency=" + tradingCurrency + ", cardType=" + cardType + "]";
    }
}
