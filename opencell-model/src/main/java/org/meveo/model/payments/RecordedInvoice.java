...
@NamedQueries({        
        @NamedQuery(name = "RecordedInvoice.listRecordedInvoiceToPayByDate", query = "Select ri from RecordedInvoice as ri,PaymentMethod as pm  where ( ri.matchingStatus ='O' or ri.matchingStatus ='P' ) "
