...
@NamedQueries({
    ...
    @NamedQuery(name = "SubAccountingPeriod.findByAPAndBeforeEndDate", query = "SELECT SAP FROM SubAccountingPeriod SAP where SAP.accountingPeriod.id = :apId and SAP.endDate <= :endDate"),
