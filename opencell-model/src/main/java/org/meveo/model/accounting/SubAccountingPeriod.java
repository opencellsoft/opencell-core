...
@NamedQueries({
    ...
    @NamedQuery(name = "SubAccountingPeriod.getRegularUsersSubPeriodWithStatusOpen", query = "SELECT SAP FROM SubAccountingPeriod SAP where SAP.accountingPeriod.id = :apId and SAP.endDate <= :endDate and SAP.regularUsersSubPeriodStatus = 'OPEN'"),
    @NamedQuery(name = "SubAccountingPeriod.getAllUsersSubPeriodWithStatusOpen", query = "SELECT SAP FROM SubAccountingPeriod SAP where SAP.accountingPeriod.id = :apId and SAP.endDate <= :endDate and SAP.allUsersSubPeriodStatus = 'OPEN'"),
