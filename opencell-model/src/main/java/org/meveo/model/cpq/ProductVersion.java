...
@NamedQueries({ 
	...
	@NamedQuery(name = "ProductVersion.findByRequestedTagType", query = "select tag from ProductVersion p LEFT JOIN p.tags as tag where tag.tagType.code IN (:tagTypeCodes)") 
})
