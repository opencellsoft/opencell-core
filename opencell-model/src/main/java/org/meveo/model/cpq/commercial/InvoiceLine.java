...
@NamedQueries({
		...
		@NamedQuery(name = "InvoiceLine.cancelByInvoiceIds", query = "update InvoiceLine il set il.status='CANCELED', il.auditable.updated = :now, r.billingRun= null, r.invoice=null, r.invoiceAggregateF=null WHERE il.invoice.id IN (:invoicesIds)"),
