...
public class AccountHierarchyDto implements Serializable {
	...
	public String toString() {
		return "AccountHierarchyDto [email=" + email + ", customerId=" + customerId + ", customerCode=" + customerCode
				+ ", sellerCode=" + sellerCode + ", customerBrandCode=" + customerBrandCode + ", customerCategoryCode="
				+ customerCategoryCode + ", currencyCode=" + currencyCode + ", countryCode=" + countryCode
				+ ", languageCode=" + languageCode + ", titleCode=" + titleCode + ", firstName=" + firstName
				+ ", lastName=" + lastName + ", birthDate=" + birthDate + ", phoneNumber=" + phoneNumber
				+ ", billingCycleCode=" + billingCycleCode + ", address1=" + address1 + ", address2=" + address2
				+ ", address3=" + address3 + ", zipCode=" + zipCode + ", state=" + state + ", city=" + city
				+ ", usePrefix=" + usePrefix + ", invoicingThreshold=" + invoicingThreshold
				+ ", discountPlansForTermination=" + discountPlansForTermination + ", customFields=" + customFields
				+ ", limit=" + limit + ", sortField=" + sortField + ", index=" + index + ", paymentMethods="
				+ paymentMethods + ", paymentMethod=" + paymentMethod + ", jobTitle=" + jobTitle + ", registrationNo="
				+ registrationNo + ", vatNo=" + vatNo + "]";
	} 
