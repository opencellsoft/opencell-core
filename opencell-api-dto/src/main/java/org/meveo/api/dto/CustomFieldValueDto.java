...
public class CustomFieldValueDto implements Serializable {
	...
	private String searchClassnameCode;
	...
	public void setSearchClassnameCode(String searchClassnameCode) {
		this.searchClassnameCode = searchClassnameCode;
	}

	public String getSearchClassnameCode() {
		return searchClassnameCode;
	}
