...
public class PaymentGatewayDto  extends BusinessDto {
	...
	return "PaymentGatewayDto [id="+id+", code=" + code + ", description=" + description + ", updatedCode=" + updatedCode + ", type=" + type + ", paymentMethodType=" + paymentMethodType + ", scriptInstanceCode=" + scriptInstanceCode + ", implementationClassName="
		+ implementationClassName + ", applicationEL=" + applicationEL + ", tradingCountryCode=" + tradingCountryCode + ", tradingCurrencyCode=" + tradingCurrencyCode + ", cardType="
		+ cardType + "]";
    }
