...
public class CRMAccountHierarchyDto extends BaseEntityDto {
	...
	public String toString() {
		return "CRMAccountHierarchyDto [crmAccountType=" + crmAccountType + ", crmParentCode=" + crmParentCode
				...
				+ ", externalRef2=" + externalRef2 + ", name=" + name + ", address=" + address + ", contactInformation="
				+ contactInformation + ", jobTitle=" + jobTitle + ", language=" + language + ", terminationReason="
				+ terminationReason + ", subscriptionDate=" + subscriptionDate + ", terminationDate=" + terminationDate
				+ ", customerCategory=" + customerCategory + ", customerBrand=" + customerBrand + ", registrationNo="
				+ registrationNo + ", vatNo=" + vatNo + ", seller=" + seller + ", mandateIdentification="
				+ mandateIdentification + ", mandateDate=" + mandateDate + ", currency=" + currency + ", caStatus="
				+ caStatus + ", creditCategory=" + creditCategory + ", dateStatus=" + dateStatus + ", dateDunningLevel="
				+ dateDunningLevel + ", dunningLevel=" + dunningLevel + ", paymentMethods=" + paymentMethods
				+ ", paymentMethod=" + paymentMethod + ", bankCoordinates=" + bankCoordinates + ", paymentTerms="
				+ paymentTerms + ", billingCycle=" + billingCycle + ", country=" + country + ", nextInvoiceDate="
				+ nextInvoiceDate + ", electronicBilling=" + electronicBilling + ", baStatus=" + baStatus + ", email="
				+ email + ", invoicingThreshold=" + invoicingThreshold + ", uaStatus=" + uaStatus + ", cfToAdd="
				+ cfToAdd + ", cfMapToAdd=" + cfMapToAdd + ", customFields=" + customFields
				+ ", discountPlansForInstantiation=" + discountPlansForInstantiation + ", discountPlansForTermination="
