...
public class DDRequestLotOpDto extends AuditableEntityDto {
	...
	/**
	 * The due date rage script code : to get the custom script computing the AOs
	 * due date range.
	 */
	private String dueDateRageScriptCode;

	/**
	 * The recurrent flag : to decide if a new dd request lot operation will be
	 * created at end , or not.
	 */
